<?php
	...
	class Twitter_model extends CI_Model{
		...
		function get_pages(){
			...
			$this->db->where('category','twitter likes');	
		...
		function get_follows(){
			...
			$this->db->where_not_in('uid',$s);
			$this->db->where_not_in('status','deactive');
			$this->db->where('category','twitter follows');	
			$qry=$this->db->get('user_posts');
			$posts=$qry->result_array();
		...
		function get_tweets(){
			...
			$this->db->where_not_in('uid',$s);
			$this->db->where_not_in('status','deactive');
			$this->db->where('category','twitter tweet');	
			$qry=$this->db->get('user_posts');
			$posts=$qry->result_array();
		...
		function get_retweets(){
			...
			$this->db->where_not_in('uid',$s);
			$this->db->where_not_in('status','deactive');
			$this->db->where('category','twitter retweet');	
			$qry=$this->db->get('user_posts');
			$posts=$qry->result_array();
